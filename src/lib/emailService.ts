...
const EMAILJS_SERVICE_ID = 'service_g9f0piz';
const EMAILJS_TEMPLATE_ID = 'template_dmg2kik';
const EMAILJS_PUBLIC_KEY = 'Aq6CjehcH-3ufmJQB';
...
export const sendStatusEmail = async (
    ...
    try {
        ...
        const templateParams = {
            ...
            user_name: toName,
            from_name: 'UNAI Antigravity Team',
