...
interface ParticleCardProps {
    ...
    enableBorderGlow?: boolean;  // Added this
}
...
export const GlobalSpotlight = ({
    ...
    `;
        ...
        const handleMouseMove = (e: MouseEvent) => {
            ...
            // Select cards that have the magic-bento-card class
...
// Main wrapper to provide context for spotlight
...
export const MagicBento = ({
    ...
    return (
        <div className={`bento-section ${className}`} ref={gridRef}> {/* Add dynamic className */}
            {enableSpotlight && (
                <GlobalSpotlight
                    gridRef={gridRef}
