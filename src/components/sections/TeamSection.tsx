...
const teamMembers: Array<{
    ...
    imageClass?: string;
        ...
        },
        {
            ...
            imageClass: "object-[80%_10%] scale-[1.03] group-hover:scale-[1.0]",
        ...
        },
        {
            ...
            imageClass: "object-[50%_20%] scale-[1.20] group-hover:scale-[1.1]",
                                ...
                                >
                                    <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden mb-6 shadow-lg group-hover:shadow-2xl transition-all duration-500 transform group-hover:-translate-y-2">
                                        <img
                                            src={member.image}
                                            alt={member.name}
                                            className={`w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-700 ${member.imageClass || 'object-[50%_20%] scale-[1.15] group-hover:scale-[1.1]'}`}
                                        />
